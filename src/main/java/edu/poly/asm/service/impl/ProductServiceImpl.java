...
//	}
	...
	public <S extends Product> S save(S entity) {
		...
		boolean isExistingProduct = entity.getProductId() != null && productRepository.existsById(entity.getProductId());

		// Nếu sản phẩm đã tồn tại và người dùng không thay đổi ảnh
		if (isExistingProduct && entity.getImage() == null) {
			// Lấy thông tin sản phẩm từ cơ sở dữ liệu
			Product existingProduct = productRepository.getById(entity.getProductId());

			// Gán ảnh từ sản phẩm đã lưu trước đó
