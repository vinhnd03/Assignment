...
public class CategoryController {
	...
	public String searchPost(ModelMap model, @RequestParam(name = "name", required = false) String name) {
	    // Xử lý yêu cầu POST tại đây
	    // Ví dụ: Lọc danh sách sản phẩm theo tên
